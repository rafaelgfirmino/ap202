...
export declare class KTSelect extends KTComponent {
     ...
     */
    private _syncNativeSelectValue;
    /**
     ...
     */
    static getInstance(element: HTMLElement): KTSelect | null;
    /**
     * Get an existing KTSelect instance or create a new one
     */
    static getOrCreateInstance(element: HTMLElement, config?: KTSelectConfigInterface): KTSelect;
    /**
     ...
     * @param items Search result items
     */
    private _updateOriginalSelectWithSearchResults;
    /**
