...
export declare class KTSticky extends KTComponent implements KTStickyInterface {
    ...
    protected _timeoutState: ReturnType<typeof setTimeout> | null;
    protected _scrollTimeout: ReturnType<typeof setTimeout> | null;
    ...
    protected _debounceScroll(callback: () => void, delay?: number): void;
