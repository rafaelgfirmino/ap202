...
var CheckedState = ((CheckedState2) => {
  ...
  itemInstance: {
    getCheckboxProps: ({ item }) => {
      ...
      return {
        ...
        ref: (r) => {
          if (r) {
            r.indeterminate = checkedState === "indeterminate";
          }
        }
      };
    },
    toggleCheckedState: (_0) => __async(null, [_0], function* ({ item }) {
      if (item.getCheckedState() === "checked") {
...
//# sourceMappingURL=chunk-ES67ZAU5.js.map
