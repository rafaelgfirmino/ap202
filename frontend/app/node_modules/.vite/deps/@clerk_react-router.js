import {
  ...
  useSignUp,
  useWaitlist
} from "./chunk-6PS7CRBI.js";
import "./chunk-UTQ67KV7.js";
import {
  useLocation,
  useNavigate,
  useParams
...
// node_modules/@clerk/react/dist/internal.mjs
...
var usePathnameWithoutSplatRouteParams = () => {
  ...
  const stablePath = (0, import_react4.useRef)(computedPath);
...
var UserProfile2 = Object.assign(
  (props) => {
    ...
    return import_react6.default.createElement(UserProfile, { ...useRoutingProps("UserProfile", props, { path }) });
  },
  { ...UserProfile }
);
var OrganizationProfile2 = Object.assign(
  (props) => {
    const path = usePathnameWithoutSplatRouteParams();
    return import_react6.default.createElement(OrganizationProfile, { ...useRoutingProps("OrganizationProfile", props, { path }) });
  },
  { ...OrganizationProfile }
);
var SignIn2 = (props) => {
  const path = usePathnameWithoutSplatRouteParams();
  return import_react6.default.createElement(SignIn, { ...useRoutingProps("SignIn", props, { path }) });
};
var SignUp2 = (props) => {
  const path = usePathnameWithoutSplatRouteParams();
  return import_react6.default.createElement(SignUp, { ...useRoutingProps("SignUp", props, { path }) });
};
