...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React103 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React103.useState, useEffect40 = React103.useEffect, useLayoutEffect6 = React103.useLayoutEffect, useDebugValue = React103.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var DismissableLayerBranch = React19.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime13.jsx)(Primitive4.div, { ...props, ref: composedRefs });
});
...
var FocusScope = React21.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Primitive5.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var Portal = React26.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal((0, import_jsx_runtime17.jsx)(Primitive6.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React38.Children.map(children, (child) => (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogTitle = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive7.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive7.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(Root6, { ...dialogScope, ...alertDialogProps, modal: true });
};
AlertDialog.displayName = ROOT_NAME;
var TRIGGER_NAME4 = "AlertDialogTrigger";
var AlertDialogTrigger = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...triggerProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime20.jsx)(Trigger3, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogOverlay = React39.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogContent = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React39.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React39.useRef(null);
        ...
        children: (0, import_jsx_runtime20.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime20.jsxs)(
          Content3,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime20.jsx)(DescriptionWarning2, { contentRef })
            ]
          }
        ) })
      }
...
var AlertDialogTitle = React39.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogDescription = React39.forwardRef((props, forwardedRef) => {
...
var AlertDialogAction = React39.forwardRef(
  (props, forwardedRef) => {
...
var AlertDialogCancel = React39.forwardRef(
  (props, forwardedRef) => {
...
var AspectRatio = React41.forwardRef(
  (props, forwardedRef) => {
...
var Avatar = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React43.useState("idle");
    return (0, import_jsx_runtime24.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime24.jsx)(Primitive9.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React43.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime24.jsx)(Primitive9.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React43.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React43.useState(delayMs === void 0);
    React43.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime24.jsx)(Primitive9.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React43.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React43.useState(
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React47.useState(null);
  const [bubbleInput, setBubbleInput] = React47.useState(null);
...
var CheckboxTrigger = React47.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React47.useRef(checked);
    React47.useEffect(() => {
...
var Checkbox = React47.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCheckbox,
      name,
    ...
    return (0, import_jsx_runtime26.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
...
var CheckboxIndicator = React47.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React47.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React47.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime26.jsx)(
      Primitive10.input,
      {
        type: "checkbox",
...
var Arrow = React51.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime29.jsx)(
    Primitive12.svg,
    {
      ...
      children: props.asChild ? children : (0, import_jsx_runtime29.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
var Popper = (props) => {
  ...
  return (0, import_jsx_runtime31.jsx)(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
Popper.displayName = POPPER_NAME;
var ANCHOR_NAME = "PopperAnchor";
var PopperAnchor = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime31.jsx)(Primitive13.div, { ...anchorProps, ref: composedRefs });
  }
);
PopperAnchor.displayName = ANCHOR_NAME;
var CONTENT_NAME5 = "PopperContent";
var [PopperContentProvider, useContentContext] = createPopperContext(CONTENT_NAME5);
var PopperContent = React53.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopper,
      side = "bottom",
    ...
    const [arrow4, setArrow] = React53.useState(null);
...
var PopperArrow = React53.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var RovingFocusGroup = React56.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime34.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime34.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime34.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var RovingFocusGroupImpl = React56.forwardRef((props, forwardedRef) => {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React56.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection2(__scopeRovingFocusGroup);
  const isClickFocusRef = React56.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React56.useState(0);
  React56.useEffect(() => {
    const node = ref.current;
    if (node) {
...
var RovingFocusGroupItem = React56.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime35.jsx)(PortalProvider2, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime35.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime35.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime35.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime35.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuContentImpl = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React57.Fragment;
    ...
    return (0, import_jsx_runtime35.jsx)(
      MenuContentProvider,
      {
        ...
        children: (0, import_jsx_runtime35.jsx)(ScrollLockWrapper, { ...scrollLockWrapperProps, children: (0, import_jsx_runtime35.jsx)(
          FocusScope,
          {
            asChild: true,
            trapped: trapFocus,
...
var MenuGroup = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(Primitive14.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(Primitive14.div, { ...labelProps, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime35.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime35.jsx)(
          Primitive14.div,
          {
            role: "menuitem",
...
var MenuCheckboxItem = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: (0, import_jsx_runtime35.jsx)(
      MenuItem,
      {
...
var MenuRadioGroup = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: (0, import_jsx_runtime35.jsx)(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
...
var MenuSubTrigger = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(MenuAnchor, { asChild: true, ...scope, children: (0, import_jsx_runtime35.jsx)(
      MenuItemImpl,
      {
...
var MenuSubContent = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React57.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime35.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime35.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime35.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime35.jsx)(
      MenuContentImpl,
      {
...
var ContextMenu = (props) => {
  ...
  const handleOpenChange = React58.useCallback(
    (open2) => {
      setOpen(open2);
...
var ContextMenuTrigger = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
      (0, import_jsx_runtime36.jsx)(Anchor2, { ...menuScope, virtualRef }),
...
var ContextMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(Portal3, { ...menuScope, ...portalProps });
};
...
var ContextMenuGroup = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime36.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
...
var ContextMenuLabel = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime36.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
...
var ContextMenuItem = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime36.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
...
var ContextMenuCheckboxItem = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
});
...
var ContextMenuRadioGroup = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
});
...
var ContextMenuRadioItem = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
});
...
var ContextMenuItemIndicator = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
...
var ContextMenuSeparator = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
});
...
var ContextMenuArrow = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime36.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var ContextMenuSub = (props) => {
  ...
  return (0, import_jsx_runtime36.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
...
var ContextMenuSubTrigger = React58.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime36.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
});
...
var DropdownMenuItem = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime38.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
...
var Form = React64.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React64.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React64.useState({});
    const getFieldValidity = React64.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React64.useCallback(
    ...
    const handleFieldValiditionClear = React64.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React64.useState({});
    const getFieldCustomMatcherEntries = React64.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React64.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React64.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React64.useState({});
    const getFieldCustomErrors = React64.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React64.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React64.useState({});
    const handleFieldMessageIdAdd = React64.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React64.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React64.useCallback(
...
var FormField = React64.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, name, serverInvalid = false, ...fieldProps } = props;
    const validationContext = useValidationContext(FIELD_NAME, __scopeForm);
    const validity = validationContext.getFieldValidity(name);
    const id = useId();
    return (0, import_jsx_runtime42.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime42.jsx)(
      Primitive18.div,
      {
...
var FormControl = React64.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React64.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React64.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React64.forwardRef(
  (props, forwardedRef) => {
    const { match, name: nameProp, ...messageProps } = props;
    const fieldContext = useFormFieldContext(MESSAGE_NAME, props.__scopeForm);
    const name = nameProp ?? fieldContext.name;
    if (match === void 0) {
      return (0, import_jsx_runtime42.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime42.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime42.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React64.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime42.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React64.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React64.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime42.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React64.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime42.jsx)(Primitive18.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime42.jsx)(import_jsx_runtime42.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React64.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime42.jsx)(Primitive18.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var HoverCard = (props) => {
  ...
  return (0, import_jsx_runtime44.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime44.jsx)(Root24, { ...popperScope, children })
    }
  );
};
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime44.jsx)(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime44.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime44.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var HoverCardContent = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime44.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime44.jsx)(
...
var HoverCardArrow = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime44.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Menubar = React68.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React68.useState(null);
    return (0, import_jsx_runtime46.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React68.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React68.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React68.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime46.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime46.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime46.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime46.jsx)(Primitive20.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React68.useRef(false);
...
var MenubarTrigger = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime46.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime46.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime46.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime46.jsx)(
          Primitive20.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime46.jsx)(Portal3, { ...menuScope, ...portalProps });
};
...
var MenubarGroup = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...groupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
MenubarGroup.displayName = GROUP_NAME5;
var LABEL_NAME5 = "MenubarLabel";
var MenubarLabel = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...labelProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
MenubarLabel.displayName = LABEL_NAME5;
var ITEM_NAME6 = "MenubarItem";
var MenubarItem = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
MenubarItem.displayName = ITEM_NAME6;
var CHECKBOX_ITEM_NAME4 = "MenubarCheckboxItem";
var MenubarCheckboxItem = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...checkboxItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
  }
);
MenubarCheckboxItem.displayName = CHECKBOX_ITEM_NAME4;
var RADIO_GROUP_NAME4 = "MenubarRadioGroup";
var MenubarRadioGroup = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioGroupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
  }
);
MenubarRadioGroup.displayName = RADIO_GROUP_NAME4;
var RADIO_ITEM_NAME4 = "MenubarRadioItem";
var MenubarRadioItem = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
  }
);
MenubarRadioItem.displayName = RADIO_ITEM_NAME4;
var INDICATOR_NAME4 = "MenubarItemIndicator";
var MenubarItemIndicator = React68.forwardRef((props, forwardedRef) => {
  const { __scopeMenubar, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime46.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
MenubarItemIndicator.displayName = INDICATOR_NAME4;
var SEPARATOR_NAME4 = "MenubarSeparator";
var MenubarSeparator = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...separatorProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
  }
);
MenubarSeparator.displayName = SEPARATOR_NAME4;
var ARROW_NAME6 = "MenubarArrow";
var MenubarArrow = React68.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...arrowProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime46.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenubarSub = (props) => {
  ...
  return (0, import_jsx_runtime46.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
MenubarSub.displayName = SUB_NAME3;
var SUB_TRIGGER_NAME4 = "MenubarSubTrigger";
var MenubarSubTrigger = React68.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React68.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React70.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React70.useState(null);
    ...
    const [isOpenDelayed, setIsOpenDelayed] = React70.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React70.useCallback(() => {
...
var NavigationMenuSub = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime48.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime48.jsx)(Primitive21.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React70.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React70.useState(null);
  return (0, import_jsx_runtime48.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React70.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React70.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
      ...
      children: (0, import_jsx_runtime48.jsx)(Collection5.Provider, { scope, children: (0, import_jsx_runtime48.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
var LIST_NAME = "NavigationMenuList";
var NavigationMenuList = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime48.jsx)(Primitive21.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime48.jsx)(Primitive21.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime48.jsx)(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime48.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuItem = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React70.useRef(null);
    const restoreContentTabOrderRef = React70.useRef(() => {
    });
    const wasEscapeCloseRef = React70.useRef(false);
    const handleContentEntry = React70.useCallback((side = "start") => {
    ...
    const handleContentExit = React70.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
    ...
    return (0, import_jsx_runtime48.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime48.jsx)(Primitive21.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React70.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React70.useRef(false);
  const open = itemContext.value === context.value;
  return (0, import_jsx_runtime48.jsxs)(import_jsx_runtime48.Fragment, { children: [
    (0, import_jsx_runtime48.jsx)(Collection5.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime48.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime48.jsx)(
      Primitive21.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime48.jsxs)(import_jsx_runtime48.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime48.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, active, onSelect, ...linkProps } = props;
    return (0, import_jsx_runtime48.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime48.jsx)(
      Primitive21.a,
      {
...
var NavigationMenuIndicator = React70.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? import_react_dom3.default.createPortal(
    (0, import_jsx_runtime48.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime48.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
    context.indicatorTrack
  ) : null;
});
NavigationMenuIndicator.displayName = INDICATOR_NAME5;
var NavigationMenuIndicatorImpl = React70.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React70.useState(
    null
  );
  const [position, setPosition] = React70.useState(null);
  ...
  return position ? (0, import_jsx_runtime48.jsx)(
    Primitive21.div,
    {
      "aria-hidden": true,
...
var NavigationMenuContent = React70.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
  ...
  return !context.viewport ? (0, import_jsx_runtime48.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime48.jsx)(
  ...
  ) }) : (0, import_jsx_runtime48.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
NavigationMenuContent.displayName = CONTENT_NAME11;
var ViewportContentMounter = React70.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React70.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React70.useRef(null);
  ...
  const motionAttribute = React70.useMemo(() => {
    const items = getItems();
  ...
  return (0, import_jsx_runtime48.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime48.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React70.forwardRef((props, forwardedRef) => {
  const { forceMount, ...viewportProps } = props;
  const context = useNavigationMenuContext(VIEWPORT_NAME, props.__scopeNavigationMenu);
  const open = Boolean(context.value);
  return (0, import_jsx_runtime48.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime48.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
NavigationMenuViewport.displayName = VIEWPORT_NAME;
var NavigationMenuViewportImpl = React70.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React70.useState(null);
  ...
  return (0, import_jsx_runtime48.jsx)(
    Primitive21.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime48.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime48.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime48.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime48.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime48.jsx)(Primitive21.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const getItems = useFocusGroupCollection(__scopeNavigationMenu);
    const context = useNavigationMenuContext(FOCUS_GROUP_ITEM_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime48.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime48.jsx)(
      Primitive21.button,
      {
        ...groupProps,
        ref: forwardedRef,
...
var OneTimePasswordField = React72.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React72.useCallback(
      (value2) => {
    ...
    const controlledValue = React72.useMemo(() => {
    ...
    const validationTypeRef = React72.useRef(validation);
    React72.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React72.useRef(null);
    const userActionRef = React72.useRef(null);
    ...
    const locateForm = React72.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React72.useCallback(() => {
    ...
    const valueRef = React72.useRef(currentValue);
    ...
    return (0, import_jsx_runtime50.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime50.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime50.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime50.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React72.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React72.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React72.useState(null);
  ...
  const keyboardActionTimeoutRef = React72.useRef(null);
  React72.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime50.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime50.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React74.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React74.useCallback(
  ...
  const focusState = React74.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React74.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React74.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React74.useState(void 0);
...
var PasswordToggleFieldIcon = React74.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime52.jsx)(Primitive23.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React76.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return (0, import_jsx_runtime54.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime54.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React76.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React76.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React76.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime54.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
PopoverAnchor.displayName = ANCHOR_NAME3;
var TRIGGER_NAME11 = "PopoverTrigger";
var PopoverTrigger = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopePopover, ...triggerProps } = props;
    const context = usePopoverContext(TRIGGER_NAME11, __scopePopover);
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime54.jsx)(
      Primitive24.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime54.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime54.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime54.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime54.jsx)(Portal, { asChild: true, container, children }) }) });
};
PopoverPortal.displayName = PORTAL_NAME9;
var CONTENT_NAME12 = "PopoverContent";
var PopoverContent = React76.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime54.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime54.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime54.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
PopoverContent.displayName = CONTENT_NAME12;
var Slot3 = createSlot("PopoverContent.RemoveScroll");
var PopoverContentModal = React76.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const contentRef = React76.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React76.useRef(false);
    React76.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime54.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: (0, import_jsx_runtime54.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React76.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const hasInteractedOutsideRef = React76.useRef(false);
    const hasPointerDownOutsideRef = React76.useRef(false);
...
var PopoverContentImpl = React76.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React76.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime54.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React78.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime56.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime56.jsx)(
      Primitive25.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React78.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React80.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime58.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React80.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime58.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime58.jsx)(
      Primitive26.span,
      {
...
var RadioBubbleInput = React80.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime59.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
function useStateMachine2(initialState, machine) {
  return React82.useReducer((state, event) => {
    const nextState = machine[state][event];
    return nextState ?? state;
  }, initialState);
}
    ...
    return (0, import_jsx_runtime61.jsxs)(import_jsx_runtime61.Fragment, { children: [
      ...
      (0, import_jsx_runtime61.jsx)(
        Primitive27.div,
        {
          ...
          children: (0, import_jsx_runtime61.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime61.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime61.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime61.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime61.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime61.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime61.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime61.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime61.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime61.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime61.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime61.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime61.jsx)(
    Primitive27.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React84.useState(null);
  const [valueNode, setValueNode] = React84.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React84.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React84.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React84.useState(/* @__PURE__ */ new Set());
  const nativeSelectKey = Array.from(nativeOptionsSet).map((option) => option.props.value).join(";");
  return (0, import_jsx_runtime63.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime63.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime63.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime63.jsx)(
          SelectNativeOptionsProvider,
          {
            scope: props.__scopeSelect,
            onNativeOptionAdd: React84.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React84.useCallback((option) => {
        ...
        isFormControl2 ? (0, import_jsx_runtime63.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime63.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React84.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React84.useRef("touch");
...
var SelectValue = React84.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime63.jsx)(
      Primitive28.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime63.jsx)(import_jsx_runtime63.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React84.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, children, ...iconProps } = props;
    return (0, import_jsx_runtime63.jsx)(Primitive28.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime63.jsx)(Portal, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React84.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React84.useState();
    useLayoutEffect2(() => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM32.createPortal(
        (0, import_jsx_runtime63.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime63.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime63.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime63.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var SelectContentImpl = React84.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [content, setContent] = React84.useState(null);
    const [viewport, setViewport] = React84.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React84.useState(null);
    const [selectedItemText, setSelectedItemText] = React84.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React84.useState(false);
    const firstValidItemFoundRef = React84.useRef(false);
    React84.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React84.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React84.useCallback(
    ...
    const itemRefCallback = React84.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React84.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React84.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime63.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime63.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime63.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React84.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React84.useState(null);
  const [content, setContent] = React84.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React84.useRef(false);
  const shouldRepositionRef = React84.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React84.useCallback(() => {
  ...
  const [contentZIndex, setContentZIndex] = React84.useState();
  useLayoutEffect2(() => {
    if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
  }, [content]);
  const handleScrollButtonChange = React84.useCallback(
    (node) => {
...
var SelectPopperPosition = React84.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React84.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React84.useRef(0);
    return (0, import_jsx_runtime63.jsxs)(import_jsx_runtime63.Fragment, { children: [
      ...
      (0, import_jsx_runtime63.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime63.jsx)(
        Primitive28.div,
        {
...
var SelectGroup = React84.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props;
    const groupId = useId();
    return (0, import_jsx_runtime63.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime63.jsx)(Primitive28.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
SelectGroup.displayName = GROUP_NAME6;
var LABEL_NAME6 = "SelectLabel";
var SelectLabel = React84.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...labelProps } = props;
    const groupContext = useSelectGroupContext(LABEL_NAME6, __scopeSelect);
    return (0, import_jsx_runtime63.jsx)(Primitive28.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React84.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React84.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime63.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React84.useCallback((node) => {
...
var SelectItemText = React84.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React84.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React84.useMemo(
      () => (0, import_jsx_runtime63.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime63.jsxs)(import_jsx_runtime63.Fragment, { children: [
      (0, import_jsx_runtime63.jsx)(Primitive28.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React84.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...itemIndicatorProps } = props;
    const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME2, __scopeSelect);
    return itemContext.isSelected ? (0, import_jsx_runtime63.jsx)(Primitive28.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME2;
var SCROLL_UP_BUTTON_NAME = "SelectScrollUpButton";
var SelectScrollUpButton = React84.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React84.useState(false);
  ...
  return canScrollUp ? (0, import_jsx_runtime63.jsx)(
...
var SelectScrollDownButton = React84.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React84.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
  ...
  return canScrollDown ? (0, import_jsx_runtime63.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectScrollButtonImpl = React84.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React84.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React84.useCallback(() => {
...
var SelectSeparator = React84.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...separatorProps } = props;
    return (0, import_jsx_runtime63.jsx)(Primitive28.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
SelectSeparator.displayName = SEPARATOR_NAME5;
var ARROW_NAME8 = "SelectArrow";
var SelectArrow = React84.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime63.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React84.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React84.useRef("");
  const timerRef = React84.useRef(0);
  const handleTypeaheadSearch = React84.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React84.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React84.useEffect(() => {
...
var Separator4 = React86.forwardRef((props, forwardedRef) => {
...
var Primitive30 = NODES30.reduce((primitive, node) => {
  ...
  const Node2 = React87.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime66.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime67.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime67.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime67.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime67.jsx)(
          SliderOrientation,
          {
...
var SliderThumb = React88.forwardRef(
  (props, forwardedRef) => {
    ...
    const index2 = React88.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime67.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime67.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime67.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime67.jsx)(
            Primitive30.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime67.jsx)(
            SliderBubbleInput,
            {
...
var Switch = React90.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React90.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React90.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
    ...
    return (0, import_jsx_runtime69.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime69.jsx)(
        SwitchBubbleInput,
        {
          control: button,
          bubbles: !hasConsumerStoppedPropagationRef.current,
...
var SwitchThumb = React90.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React90.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React94.useState(0);
  const isFocusedToastEscapeKeyDownRef = React94.useRef(false);
  const isClosePausedRef = React94.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime73.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime73.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React94.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React94.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React94.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React94.useRef(null);
    const headFocusProxyRef = React94.useRef(null);
    const tailFocusProxyRef = React94.useRef(null);
    ...
    const getSortedTabbableCandidates = React94.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime73.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime73.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime73.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime73.jsx)(Primitive33.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime73.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React94.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React94.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime73.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime73.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React94.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React94.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React94.useRef(null);
    const swipeDeltaRef = React94.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React94.useRef(0);
    const closeTimerRemainingTimeRef = React94.useRef(duration);
    ...
    const startTimer = React94.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React94.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime73.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime73.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime73.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM38.createPortal(
        (0, import_jsx_runtime73.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime73.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React94.useState(false);
  const [isAnnounced, setIsAnnounced] = React94.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React94.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime73.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime73.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime73.jsxs)(import_jsx_runtime73.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime73.jsx)(Primitive33.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime73.jsx)(Primitive33.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React94.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime73.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime73.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime73.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime73.jsx)(
      Primitive33.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React94.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React96.forwardRef((props, forwardedRef) => {
...
var ToggleGroup = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime77.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime77.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime77.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime77.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime77.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime77.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime77.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime77.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime77.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime77.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime77.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime77.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime77.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var Toolbar = React100.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime79.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime79.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React100.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React100.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime79.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime79.jsx)(Primitive36.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React100.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime79.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime79.jsx)(
      Primitive36.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React100.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React100.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime79.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime79.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React102.useRef(true);
  const isPointerInTransitRef = React102.useRef(false);
  const skipDelayTimerRef = React102.useRef(0);
  React102.useEffect(() => {
  ...
  return (0, import_jsx_runtime81.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React102.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React102.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React102.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React102.useState(null);
  const contentId = useId();
  const openTimerRef = React102.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React102.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React102.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React102.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    wasOpenDelayedRef.current = false;
    setOpen(true);
  }, [setOpen]);
  const handleClose = React102.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    setOpen(false);
  }, [setOpen]);
  const handleDelayedOpen = React102.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime81.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime81.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React102.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React102.useCallback(() => {
...
var TooltipTrigger = React102.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React102.useRef(false);
    const handlePointerUp = React102.useCallback(() => isPointerDownRef.current = false, []);
    React102.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime81.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime81.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime81.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React102.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime81.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime81.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime81.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React102.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React102.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React102.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React102.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React102.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime81.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React102.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime81.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime81.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime81.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime81.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime81.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React102.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime81.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
